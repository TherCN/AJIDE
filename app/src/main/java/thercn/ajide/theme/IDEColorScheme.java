 ...
 * @author Akash Yadav
 */
public class IDEColorScheme extends EditorColorScheme {

	protected IDEColorScheme() {}
	...
	public static IDEColorScheme newInstance(Context context) {
		if (context == null) {
			return new IDEColorScheme();
		}
		final EditorColorScheme scheme = new EditorColorScheme();
